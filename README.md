...
采访、旧稿和灵感继续留在 Vault。选中真正相关的内容，让 Agent 帮你找角度、搭结构或改一段。

### 文章写完了，排版还没开始

正文继续在 Markdown 里改；手机预览、图片和公众号排版在右侧同步更新。

### 同一篇草稿还要继续修改

标题不变就更新原草稿；标题改变就创建新草稿，不悄悄覆盖旧稿。

### 没有固定 IP，也想先跑通

可以主动选择 Write Cloud 免费体验。公众号首次符合条件的真实验证赠送 8 个体验积分，成功同步一次消耗 1 分。
